...
public class MainGUI : MonoBehaviour {
	...
	void OnGUI ()
	{
		...
		{
			TowerPlacement.Tower1ButtonPressed = true;

			//GameObject.Instantiate(BaseTower);
		...
		GUI.Label(new Rect (Screen.width - 120, Screen.height - 25, 120, 50), StaticValues.Money.ToString());
